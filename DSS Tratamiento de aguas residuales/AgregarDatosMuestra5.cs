...
{
    public partial class AgregarDatosMuestra5 : Form
    {
        public AgregarDatosMuestra5(string ID, string Cliente, string Fecha, string Captador, string Analista, string Observacion)
        {
            InitializeComponent();
            id = ID;
            cliente = Cliente;
        ...
        public AgregarDatosMuestra5(string ID, string Captador, string Analista, string Observacion,
            string temperatura, string turbiedad, string conductividad, string od, string caudal, string dbo5, string sst)
        {
            InitializeComponent();
            id = ID;
            captador = Captador;
            ...
            this.Text = "Actualizar datos de Muestra " + ID;
        ...
        private void InsertarDatosMuestra(string id, string parametro, string resultado)
        {
            EjecutarQuery("INSERT INTO Realizar_estudio (id_muestra,id_punto, id_parametro,resultado) VALUES" +
                "(" + "'" + id + "', 5, " + parametro + ", " + CheckNull(resultado) + ")");
        }
